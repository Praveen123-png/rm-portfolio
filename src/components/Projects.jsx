...
function Projects() {
  return (
    <>
      ...
      <span className="pl-15 my-20 pt-20 flex items-center" id="projects">
        <span
      ...
      <div className="flow-root lg:px-20 md:px-15 mb-20 sm:px-10 px-5">
        <div className="-my-4 gap-5 flex flex-col divide-y divide-gray-200">
          <details
            data-aos="fade-right"
            data-aos-duration="300"
            className="bg-violet-100 hover:bg-violet-200 rounded-2xl group lg:px-20 md:px-15 sm:px-10 px-5 transition-all ease-in py-10 [&amp;_summary::-webkit-details-marker]:hidden"
          >
            ...
            <div className="pt-4 rounded-4xl mx-7 flex flex-col gap-5 justify-center items-center lg:px-20 md:px-15 sm:px-10 px-5 text-gray-900">
              <div>
                <div>
                  <span className="font-semibold text-lg">Technologies: </span>
                  Angular, NodeJs and PostgreSQL
                </div>
              </div>
