            ...
            <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-[#D1D1C7] transition hover:opacity-75"
                >
              ...
              <li>
                <a
                  href="https://www.instagram.com/rakesh_mahendran_0205?igsh=MXhydWJvbGRiNmdzbQ=="
                  target="_blank"
                  className="text-[#D1D1C7] transition hover:opacity-75"
                >
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/rakesh-mahendran-b545211b4?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  rel="noreferrer"
                  target="_blank"
                  className="text-[#D1D1C7] transition hover:opacity-75"
                >
