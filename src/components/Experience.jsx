            ...
            <div className="relative flex items-start gap-4 group-odd:flex-row-reverse group-odd:text-left group-even:order-last">
              ...
              >
                ...
                <p className="mt-0.5 text-md pt-3 text-gray-700">
                  ...
                  tracking and material procurement. Gained hands-on experience
                  in <strong>C#, .NET, and Visual Basic</strong> while improving
            ...
            <div className="relative flex items-start gap-4 group-odd:flex-row-reverse group-odd:text-right group-even:order-last">
              ...
              >
                ...
                <p className="mt-0.5 text-md pt-3 text-gray-700">
                  ...
                  <strong>Ebitaus Pvt Ltd</strong>, developing modern,
                  ...
                  <strong>School Chimes</strong>, achieving over 70% better
                  client engagement and smoother communication systems.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex items-start gap-4 group-odd:flex-row-reverse group-odd:text-left group-even:order-last">
              ...
              >
                ...
                <p className="mt-0.5 text-md pt-3 text-gray-700">
                  ...
                  vegetables, expanding cross-industry expertise in technology
